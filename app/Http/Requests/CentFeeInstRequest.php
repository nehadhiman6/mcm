...
class CentFeeInstRequest extends FormRequest
{
    protected $data = [];
    protected $response = [];
    ...
    public function rules()
    {
        ...
        $feebill = \App\FeeBill::normal()->whereStdId($this->student->id)->whereInstallId($this['formdata']['installment_id'])->first();
        if ($feebill) {
            $rules['inst'] = "required";
        }
...
//      dd($to_be_removed);
            ...
            $feebill->fill(['course_id' => $this['student_det']['course_id'], 'std_type_id' => $this->student->std_type_id,
        ...
        'fee_type' => 'Centeralized-Installment','fund_type'=>'C', 'fee_amt' => $fee_amt, 'bill_amt' => $bill_amt, 'amt_rec' => $amt_rec, 'concession' => $concession, 'remarks' => $this['formdata']['remarks']
      ]);
          ...
          'concession_id' => $this['formdata']['concession_id'],
          'fee_type' => 'Centeralized-Installment','fund_type'=>'C', 'details' => $this['formdata']['remarks'], 'amount' => $amt_rec
        ]);
