...
<div class="box box-info" id='app'>
  <div class="box-header with-border">
    <h2 class="box-title">Edit Subjects</h2>
  </div>
  ...
  <div class="box-footer">
    {!! Form::submit('Update Subject',['class' => 'btn btn-primary','@click.prevent'=>'updateSubjects']) !!}
  </div>
  {!! Form::close() !!}
  ...
  var vm = new Vue({
    ...
    methods: {
      updateSubjects: function() {
        this.errors = {};
        this.$http['post']("{{ url('students/') .'/' . $student->id .'/subjects'}}", this.$data)
