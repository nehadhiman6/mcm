...
<div class="box box-default box-solid" v-cloak>
  ...
  <div class="box-footer">
    ...
    {!! Form::submit('Hostel Pending',['class' => 'btn btn-primary', '@click.prevent' => 'pending']) !!}
   ...
   //   institution:'',
    ...
    methods: {
      getData: function() {
        ...
        this.fails = false;
        self = this;  
        this.$http.get("{{ url('misc-debit-hostel') }}/"+this.course_id, { params: { 'subhead_id': this.subhead_id}})
      ...
      pending: function() {
        ...
        this.fails = false;
        self = this;  
        this.$http.get("{{ url('hostel-pending') }}/"+this.course_id, { params: { 'subhead_id': this.subhead_id}})
          .then(function (response) {
          this.response = response.data;
          self.students = [];
          self.form_loaded = true;
      ...
      saveData: function() {
        this.errors = {};
        this.fails = false;
        this.$http.post("{{ url('misc-debit-hostel') }}", this.$data)
          .then(function (response) {
            self.data_sent = true;
            // this.classes = response.data;
            // console.log(response.data);
