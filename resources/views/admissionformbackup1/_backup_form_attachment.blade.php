<div id="attachment">
  ...
  <div class="box-body">
    ...
    <table class="document">
      <tr :files="files" :attach-url="attachUrl" :adm_id="adm_id" is="fileUpload" opt-name="photograph" opt-label="Photograph" :show-label='false' msg="Picture size should fall between 10 KB to 100 KB. The dimensions of the photograph should be 3.5 * 4.5 cms (width*height) and scan the photograph on 200 dpi. Photograph should not be taken by mobile phone camera."></tr>
      <tr :files="files" :attach-url="attachUrl" :adm_id="adm_id" is="fileUpload" opt-name="signature" opt-label="Signature" :show-label="false" msg="Dimensions 6x3 cms (width*height) on a plain white sheet. Keep the size of the image between 10 KB to 100 KB and scan the signature on 200 dpi. Signature should be done with thick point Black/Blue pen only. Signatures having only Initials or done in CAPITAL letters are not acceptable."></tr>
