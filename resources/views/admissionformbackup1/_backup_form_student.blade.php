<fieldset>
  ...
  <div class='form-group' >
    {!! Form::label('last_exam_mcm','Old student MCM college 2017-2018?',['class' => 'col-sm-3 control-label required']) !!}
      <div class="col-sm-2" >
        <label class="radio-inline">
          {!! Form::radio('last_exam_mcm', 'Y',null, ['class' => 'minimal','v-model'=>'last_exam_mcm','@change'=>'lastExamStatus',':disabled'=>'form_id > 0']) !!}
         Yes
        </label>
        <label class="radio-inline">
          {!! Form::radio('last_exam_mcm', 'N',null, ['class' => 'minimal','v-model'=>'last_exam_mcm','@change'=>'lastExamStatus',':disabled'=>'form_id > 0']) !!}
          No
      </div>
      {!! Form::label('lastyr_rollno','Enter College Roll no.',['class' => 'col-sm-3 control-label required' ,'v-show'=>"last_exam_mcm == 'Y'"]) !!}
      <div class="col-sm-2" v-if="last_exam_mcm == 'Y'"  v-bind:class="{ 'has-error': errors['lastyr_rollno'] }"> 
        {!! Form::text('lastyr_rollno',null,['class' => 'form-control','v-model'=>'lastyr_rollno','@blur'=>'getStudentDetails',':disabled'=>'form_id > 0']) !!}
      </div>
...
<!--      <input type="text" v-model="nationality" class="form-control" null :readonly = "foreign_national=='N'" >-->
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3" v-bind:class="{ 'has-error': errors['name'] }">
      {!! Form::text('name',null,['class' => 'form-control','max-length'=>'50','v-model'=>'name' ,':disabled'=>'oldstudentDetails.name']) !!}
    ...
    <div class="col-sm-3" v-bind:class="{ 'has-error': errors['dob'] }">
      {!! Form::text('dob',null,['class' => 'form-control app-datepicker','v-model'=>'dob', ':disabled'=>'oldstudentDetails.dob && inOffice == false']) !!}
  ...
  <div class='form-group'>
    ...
    <div class="col-sm-3" v-bind:class="{ 'has-error': errors['father_name'] }">
      {!! Form::text('father_name',null,['class' => 'form-control','v-model'=>'father_name' ,':disabled'=>'oldstudentDetails.father_name']) !!}
    ...
    <div class="col-sm-3" v-bind:class="{ 'has-error': errors['mother_name'] }">
      {!! Form::text('mother_name',null,['class' => 'form-control','v-model'=>'mother_name' ,':disabled'=>'oldstudentDetails.mother_name']) !!}
  ...
  <div class="form-group">
    {!! Form::label('boarder','Boarder/Day Scholar',['class' => 'col-sm-2 control-label required']) !!}
    ...
    <div class="col-sm-2" v-bind:class="{ 'has-error': errors['blood_grp'] }">
      {!! Form::select('blood_grp',getBloodGroup(),null,['class' => 'form-control','v-model'=>'blood_grp','disabled']) !!}
