<div id="attachment">
  ...
  <div class="box-header with-border">
    <h3 class=box-title>DOCUMENTS TO BE UPLOADED (Whichever applicable)</h3>
  </div>
  <div class="box-body">
    ...
    <table class="document">
      ...
      <tr :files="files" :attach-url="attachUrl" :adm_id="adm_id" is="fileUpload" opt-name="parent_signature" opt-label="Parent/Guardian Signature" :show-label="false" msg="Dimensions 6x3 cms (width*height) on a plain white sheet. Keep the size of the image between 10 KB to 20 KB and scan the signature on 200 dpi. Signature should be done with thick point Black/Blue pen only. Signatures having only Initials or done in CAPITAL letters are not acceptable."></tr>
  ...
  <template id="file-template">
    <tr>
      <td>
        <span id="@{{ optName }}">  <i :src="url+'?'+new Date().getTime()" width="100" height="120" v-if="url && (optName == 'photograph' || optName == 'signature' || optName == 'parent_signature')"></span>
