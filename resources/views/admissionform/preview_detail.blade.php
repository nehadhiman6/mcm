...
<section class="invoice">
  ...
  <div class="row invoice-info">
    ...
    <div class="col-sm-4 invoice-col">
      <div class="column4">
        <img src = "@if(isset($guard )&& $guard == 'students' ) {{ url('stdattachment/' . $student->id) }}/photograph 
           @else {{ url('attachment/' . $student->id) }}/photograph @endif"
           height="178" width= "186" class="student-image" alt="Student Image">
      </div>
      <div class="column5">
        <img src = "@if(isset($guard )&& $guard == 'students' ) {{ url('stdattachment/' . $student->id) }}/signature 
           @else {{ url('attachment/' . $student->id) }}/signature @endif"
           height="60" width= "186" class="student-image" alt="Signature">
      </div>
    </div>
