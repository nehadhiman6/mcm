...
<div class="row no-print">
    <div class="col-xs-12">
        <a href="{{url('admissions/'.$student->id.'/printdetail')}}" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
...
<section class="invoice">
    <div class ="first-page">
        ...
        <div class="column4">
            <img src="" class="student-image" alt="Student Image">
        </div>
        <div class="applicant">
            <div class="row-1">
        ...
        <div class="subjects">
            <div class="row-2">
                ...
                <div class="col-xs-6 col-sm-4"><b class="p-head">Subject:{{ $i }}</b>{{ $subject->subject->subject}} {{ $subject->subjectGroup->subject or '' }}</div>
                <?php $i++; ?>
                @endforeach
             </div>
        </div>
