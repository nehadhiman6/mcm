<fieldset>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      {!! Form::select('course_type',[''=>'Select','GRAD'=>'UG','PGRAD'=>'PG'],(isset($course_type) ? $course_type : ''),['class' => 'form-control','v-model'=>'course_type',':disabled'=>'oldstudentDetails.course_id']) !!}
    </div>
    ...
    <div class="col-lg-2 col-sm-3" v-bind:class="{ 'has-error': errors['course_id'] }">
      <select class="form-control" v-model="course_id" @change='showSubs' :disabled="oldstudentDetails.course_id">
  ...
  <div  v-bind:class="{ 'has-error': errors['punjabi_in_tenth'] }" v-show = "course_type != 'PGRAD'">
    {!! Form::label('punjabi_in_tenth','Have you studied Punjabi in Class X and XII?',['class' => 'col-sm-4 control-label required']) !!}
    <label class="radio-inline" >
        {!! Form::radio('punjabi_in_tenth', 'Y',null, ['class' => 'minimal punjabiInTenth','v-model'=>'punjabi_in_tenth', ':disabled'=>'disable_pbi_in_tenth && getCourseType == "GRAD"']) !!}
        Yes
      </label>
      <label class="radio-inline" :disabled = "last_exam_mcm == 'Y'">
        {!! Form::radio('punjabi_in_tenth', 'N',null, ['class' => 'minimal punjabiInTenth','v-model'=>'punjabi_in_tenth', ':disabled'=>'disable_pbi_in_tenth && getCourseType == "GRAD"']) !!}
        No
      </label>
  ...
  <div class = "col-lg-offset-2" v-show = "course_type != 'PGRAD'"> Note :HISTORY AND CULTURE OF PUNJAB is only for those who have not studied punjabi in class X and XII.</div>
  <ul class = ""><comp-grps v-for="cgrp in compGrp" :old-subjects='old_subjects' :cgrp='cgrp' type='C' :disable-subjects="form_id > 0 && canChangeSubjects == false"></comp-grps></ul>
  ...
  <div v-for="elective in electives">
    <div v-show='elective.elective_subjects.length > 0 || elective.groups.length > 0'>
      ...
      <div v-if='selected_ele_id == 0 || elective.id == selected_ele_id'>
            ...
            <div v-for="sub in elective.elective_subjects">
              <div class="col-sm-12">
                <label class="checkbox" >
                        <input type="checkbox" name= "optional_sub[]" value= "@{{ sub.subject_id }}" :disabled="(sub.sub_type == 'C' || ((old_subjects.length > 0 || form_id > 0) && canChangeSubjects == false))" number v-model="selectedOpts" class="">
                        @{{ sub.subject.subject }}      
                </label>
              </div>
            </div>
        ...
        <ul class = ""><comp-grps v-for="cgrp in elective.groups" :cgrp='cgrp' :old-subjects='old_subjects' :type='cgrp.type' :disable-subjects="form_id > 0 && canChangeSubjects == false"></comp-grps></ul>
      </div>
    </div>
  </div>
  ...
  <div v-if="getSelectedCourse.course_year != 3">
...
<h4 v-if="course_type =='GRAD'">Add-on Course (Please select)</h4>
...
<fieldset>
  ...
  <div class='form-group' >
    ...
    <div class="col-sm-3"  v-bind:class="{ 'has-error': errors['pu_regno'] }">
      {!! Form::text('pu_regno',null,['class' => 'form-control','v-model'=>'pu_regno']) !!}
    ...
    <div class="col-sm-3"  v-bind:class="{ 'has-error': errors['pupin_no'] }">
      {!! Form::text('pupin_no',null,['class' => 'form-control','v-model'=>'pupin_no','placeholder'=>'11 digit identification no.(if any)']) !!}
  ...
  <div class="academics" v-for='acade in acades'>
    ...
    <div class='form-group'>
      ...
      <div class="col-sm-3">
        <input type="text"  v-model='acade.other_board' :disabled="acade.board_id !== 0"  class="form-control" placeholder="Enter Board/Univercity (If Others)"/>
      </div>
    ...
    <div class="form-group">
      {!! Form::label('total_marks','Total Marks',['class' => 'col-sm-2 control-label','v-bind:class'=>"{ 'required': acade.result == 'PASS' }"]) !!}
      ...
      {!! Form::label('marks_obtained','Marks Obtained',['class' => 'col-sm-2 control-label','v-bind:class'=>"{ 'required': acade.result == 'PASS' }"]) !!}
      ...
      <div class="col-sm-1" v-bind:class="{ 'has-error': errors['acades.'+$index+'.marks_per'] }">
    ...
    {!! Form::label('subjects','Subjects Offered',['class' => 'col-sm-2 control-label required']) !!}
      <div class="col-sm-4" v-bind:class="{ 'has-error': errors['acades.'+$index+'.subjects'] }">
  ...
  <h5>(Details of the Subject in which applying for Masters)</h5>
  <div class="academics" v-if="course_type == 'PGRAD'">
    ...
    <div class='form-group'>
        {!! Form::label('marks_obtained','Marks obtained',['class' => 'col-sm-2 control-label required']) !!}
        ...
        {!! Form::label('total_marks','Total Marks',['class' => 'col-sm-1 control-label required']) !!}
    ...
    <div class="form-group">
        {!! Form::label('honour_total_marks','Total Marks',['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-3" >
    ...
    <div class="form-group">
        {!! Form::label('ele_total_marks','Total Marks',['class' => 'col-sm-2 control-label required']) !!}
    ...
    <div class="form-group" v-if="lastyr_rollno != ''">
        {!! Form::label('pg_sem1_total_marks','Total Marks',['class' => 'col-sm-2 control-label required']) !!}
    ...
    <div class="form-group"  v-if="lastyr_rollno != ''">
        {!! Form::label('pg_sem2_total_marks','Total Marks',['class' => 'col-sm-2 control-label ','v-bind:class'=>"{ 'required': postgraduate.pg_sem2_result == 'PASS' }"]) !!}
  ...
  <div class='form-group'>
    {!! Form::label('disqualified','Have you ever disqualified by any board/body/council/university. If yes, give detail',['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-1">
  ...
  <div class='form-group'>
    ...
    <div v-if="academic == 'Y' || cultural == 'Y' || sports == 'Y'" class="col-sm-12" v-bind:class="{ 'has-error': errors['spl_achieve'] }">
      ...
      <div class="col-sm-3">
        {!! Form::text('spl_achieve',null,['class' => 'form-control','v-model'=>'spl_achieve']) !!}
      </div>
...
<fieldset>
  <legend>Hostel</legend>
    <div class="form-group"  v-if="hostel == 'Y'">
      <div class="col-sm-7">
        <p class= "control-label"><b>Note :Hostel seat allotment is subject to the filling of hostel form and availability of seats.</b>
      </div>
    </div>
    <div class='form-group'>
      {!! Form::label('hostel','Applied for Hostel',['class' => 'col-sm-2 control-label']) !!}
      <div class="col-sm-1">
        <label class="col-sm-1 checkbox">
    ...
    <div class='form-group' v-if="hostel == 'Y'">
        {!! Form::label('schedule_backward_tribe','Do you belong to Scheduled Catse/Schedule Tribe/Backward Class?',['class' => 'col-sm-6 control-label required']) !!}
...
<fieldset >
  <legend>For Migration Cases Only</legend>
    ...
    <div v-if="migration == 'Y'">
      ...
      <div class="col-sm-12">
        <p><br>
          <b>Note:-Original copy of migration to be submitted to the college by September 15.</b><br>
          In case of deficient subjects you have to clear the subjects in next two consecutive examination held by the university otherwise admission will be cancelled.
        </p>
      </div>
    </div>
</fieldset>
...
<script>
 ...
 var vm = new Vue({
    ...
    data: {
      ...
      courses: {!! getCoursesForAdmForm(true) !!},
      min_optional: "{!! isset($course) ? $course->min_optional : '' !!}",
      acades: {!! $adm_form->academics->count() > 0 ? json_encode($adm_form->academics) : "[{exam: '',other_exam:'', last_exam: 'Y', institute: '', board_id: 0, rollno: '', year: '', result: '',total_marks: '',marks_obtained: '' , marks_per: '', subjects: '', other_board: '',reappear_subjects:'',division:''}]" !!},
      ...
      remarks_diff_abled:'',
      epic_card:"{{ isset($adm_form)? ($adm_form->epic_card == 'Y' ? 'Y' : 'N') : 'Y' }}",
      adhar_card:"{{ isset($adm_form) ? ($adm_form->adhar_card == 'Y' ? 'Y' : 'N') :'Y'  }}",
      spl_remarks:'',
      spl_achieve:'',
    ...
    methods: {
      ...
      lastExamStatus: function() {
        // console.log(this.last_exam_mcm);
    ...
    computed: {
      ...
      canChangeSubjects: function() {
        ...
        @endif
        var c = this.getSelectedCourse;
        if(this.lastyr_rollno && c && c.course_id == 'BA') {
          return false;
        }
        return true;
      },
