...
<div class="box box-default box-solid" id='app'>
  ...
  {!! Form::open(['method' => 'GET', 'action' => ['Reports\HostelStrengthController@index'], 'class' =>
  'form-horizontal']) !!}
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="col-sm-2">
        {!! Form::select('adm_source',[''=>'All','offline'=>'Offline','online'=>'Online'],null,['class' =>
        'form-control','v-model'=>'adm_source']) !!}
      </div>
...
//              console.log(colNo);
  ...
  methods: {
    getData: function() {
        ...
        this.$http.get("{{ url('hostel-strength') }}", {params: data})
