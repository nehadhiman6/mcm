...
<div class="box box-info" id = "app">
  <div class="box-header with-border">
    <h3 class="box-title">Centeralized Fee Installments</h3>
  </div>
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="col-sm-3">
      {!! Form::select('install_id',getInstallment('C'),null,['class' => 'form-control', 'v-model' => 'formdata.installment_id']) !!}
      </div>
  ...
  var vm = new Vue({
    ...
    methods:{
      showDetail: function() {
        ...
        this.$http.get("{{ url('cent-fee-insts/create') }}", {params: data})
      ...
      save: function() {
        this.errors = {};
        this.saving = true;
        this.$http.post("{{ url('cent-fee-insts') }}", this.$data)
          .then(function (response) {
