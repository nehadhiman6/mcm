  ...
  <div class="panel-body">
    <div class="row">
      <div class="col-sm-6">
        ...
        <p><span class="label-name">CLASS:</span>@{{ student.course_name}}</p>
    ...
    //      "serverSide": true,
          ...
          columnDefs: [
            ...
            { title: 'Balance', targets: 5, data: 'dramt', 
              render: function( data, type, row, meta) {
                stdBal += (data - row.cramt);
                return stdBal >= 0 ? 'Dr '+stdBal : 'Cr '+stdBal;
              }},
   ...
   methods: {
      getData: function() {
         this.errors = {};
          ...
          this.$http.get("{{ url('hostels/outsiders/ledger') }}", {params: data})
