...
class AlumniLifeMemberFeeController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $payment->fill([
            ...
            'trn_type' => 'alumni_life_fee',
            'email' => $alumni_user->email,
            'mobile' => $alumni_user->almForm->mobile,
            'amt' => config('college.alumni_life_fee'),
            'trdate' => date('mdYHis'),
    ...
    public function feeStatus()
    {
        ...
        $alumni_payments = $alumni_payments->get();
        return view('alumni.alumnipayments', compact('alumni_payments'));
    }
}
