      ...
      <div class="box box-default box-solid" >
            ...
            <div class="box-body">
                <div class="box-body">
                  ...
                  <div class="box-body"> 
                    {!! Form::label('','Send Mail',['class' => 'col-sm-3 control-label ']) !!}
                    <div class="col-sm-12">
    ...
    <script>
        ...
        methods: {
            ...
            sendSms: function() {
                ...
                this.$http.post("{{ url('send-stu-result-email') }}", data)
        ...
        //            this.classes = response.data;
            ...
            showRecord:function(){
                ...
                self.reset();
                this.$http.get("{{ url('send-stu-result-email') }}",{
                    params: {
            ...
            setColumns() {
                ...
                self.columnDefs.push({ title: 'Action', targets: target++, data: 'id',
                    "render":function(data, type, row, meta){
                        var str ='';
                        str+= '<a target="_blank" href="'+self.base_url+'/'+ 'report-card-print/'+data+'/'+self.course_id+'/'+self.exam_name+'/'+self.semester+'" class="btn btn btn-primary">Print</a>';
                        return str;
