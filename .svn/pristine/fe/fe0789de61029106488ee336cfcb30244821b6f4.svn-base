...
<fieldset class="terms">
    <legend><h4>Instructions for Filling Online Application Form</h4></legend>
        ...
        {{-- <li>Students seeking admission to courses regulated through <b>Online Centralized Admission</b> are also required to fill the Online College Admission Form if their name is in the merit list of Mehr
             Chand Mahajan DAV College for Women.</li>
        <li><b>Online College Admission Form is to be filled by all the students seeking admission.</b></li>
        <li>Filling Online Admission Form <b>(for non-centralized courses)</b> does not imply or guarantee the following:</li>
            <ul class="instruction-ul"><li>admission to the applied course</li>
            <li>subject combination opted for</li>
            <li>honours allotment </li></ul>
        <li>Print-out of duly filled Admission Form to be submitted in College as per the admission schedule given in Online College Prospectus at
            <b> www.mcmdavcw-chd.edu / www.mcmdav.com</b></li>
        <li>Students must submit the form in person and bring their original certificates for verification 
            at the time of admission.</li>
        <li>Admission will be confirmed only on the day of admission after:</li>
        <ul class="instruction-ul"><li>Scrutiny of the Admission Form</li>
            <li>Verification of original documents </li>
            <li>Recommendation of Admission Committee</li>
            <li>Completing all the other college formalities</li></ul>
        <li>After completing admission formalities, pay College Fee Online</li>
        <li>To confirm admission, login to registered student account and check successful status of  Fee Payment</li>
        <br>

        <b>Documents required before filling the Online Application Form</b>
        <li>Scanned photographs in <b>.jpg, .png,.bmp,.jpeg</b> format (not more than 100KB in size)  should be <b>3.5 x 4.5 cm</b> (width*height)</li>
        <li>Scanned copy of candidate’s signatures in <b>.jpg, .png,.bmp,.jpeg</b> (not more than 100 KB) should be <b>6 x 3 cm</b> (width*height)</li>
        <li>Detailed mark sheets in  <b>.pdf </b> format and size should not be more than 300KB. Resolution should be more than 200 dpi and less than 300 dpi.</li>
        <li>The candidate must have her personal valid email id.</li>
        <br>
        
        <b>Instructions to fill the Online Application Form</b>
        <li>Go to Student Login and Register</li>
        ...
        <li>Upload the relevant and required documents.</li>
        <li>Preview the Application Form and make corrections (if any).</li>
        <li>Pay your processing fee through net-banking or online mode of payment.</li>
        <li>No changes in the form are allowed after the final submission.</li>


        <br>
        <b>Documents to be attached with the Printout of the Admission form</b>
        <li>New students should attach self-attested photocopies of the following documents:</li>
            ...
            <ul class="sub-instruction-ul">
                <li>Gap Year (if any)</li>
                <li>Girl child category affidavit (on a stamp paper worth Rs 20/-) duly attested by a first class magistrate. Parents must declare that the benefit
                     is obtained for only one girl child in case of two girl children.</li>
                <li>Reserved Category (if any)</li>
            </ul>
        ...
        <li>A student whose result of Class XII examination conducted by her respective School Board is published late, 
            but not later than 14th August, may be admitted without late fee within 15 working days of the declaration 
            of the result and her attendance will be counted from the date of admission.</li>
        <li>Students seeking admission in Postgraduate courses must also attach self-attested photocopies of 
            the detailed mark sheets of all: </li>
        <li>Six semesters of the graduate degree </li>
        <li>Honours mark sheet </li>
        <li>Old students of the College (Undergraduate & Postgraduate) should attach self-attested photocopies of
             the result of all the preceding semester examinations. </li> --}}
        <li>Students seeking admission to courses regulated through <b>Online Centralized Admission</b> are also required to fill the Online College Admission Form if their name is in the merit list of Mehr Chand Mahajan DAV College for Women.</li>
        <li><b>Online College Admission Form is to be filled by all the students seeking admission.</b></li>
        ...
        <li>Print-out of duly filled Admission Form to be submitted in College as per the admission schedule given in Online College Prospectus at <b> https://mcmdavcwchd.edu.in</b></li>
        <li>Students must submit the form in person and bring their original certificates for verification at the time of admission.</li>
        <li>Admission will be confirmed only on the day of admission after:</li>
            <ul class="instruction-ul">
       ...
       <br><span class="highlighted-instruction" > <b>*Online Centralized Admissions : College admission form to be filled only after allotment of seat at DHE portal
</b> </span>
