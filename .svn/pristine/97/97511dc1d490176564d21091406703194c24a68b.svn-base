<fieldset v-show="course_id && course_id != 14">
...
<script>
 ...
 var vm = new Vue({
    ...
    data: {
      ...
      acades: {!! $adm_form->academics->count() > 0 ? json_encode($adm_form->academics) : "[{exam: '',other_exam:'', last_exam: 'Y', institute: '', board_id: 0, rollno: '', year: '', result: '',total_marks: '',marks_obtained: '' , marks_per: '', subjects: '', other_board: '',reappear_subjects:'',division:'',inst_state_id:0,cgpa:'N'}]" !!},
