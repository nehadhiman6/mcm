...
<div class="box box-info" id = "app" v-cloak>
  ...
  <div class="box-body">
    <div class="form-group">
      {!! Form::label('form_no','Form No',['class' => 'col-sm-3 control-label']) !!}
      <div class="col-sm-3">
      ...
      <div class='form-group'>
        ...
        <div v-bind:class="{ 'has-error': errors['formdata.receipt_date'] }">
          ...
          <div class="col-sm-2">
            ...
            <!--{!! Form::text('receipt_date',today(),['class' => 'form-control','v-model'=>'formdata.receipt_date','readonly']) !!}-->
      ...
      showDetail: function() {
        ...
        this.$http.get("{{ url('admissions/create') }}", {params: data})
          .then(function (response) {
            ...
            this.formdata.std_type_id = response.data.adm_entry.std_type_id;
...
//            });
      ...
      admit: function() {
        this.errors = {};
        this.saving = true;
        this.$http.post("{{ url('admissions') }}", this.$data)
          .then(function (response) {
